...
<div class="quanbu">
    ...
    <div id="loginAndRegister"><a href="javascript:;" class=" btn-large theme-login"><img src="../Public/images/login.png"class="login"></a>
        <a href="<?php echo U('Index/index/register');?>"><img src="../Public/images/register.png" class="register"></a>
    </div>
